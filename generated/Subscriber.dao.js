const sql=require('./Subscriber.sql.json')
        ...
        const db = new Database('Subscriber.db', { verbose: console.log }); 
        module.exports={
drop,
    clear,
    create,
...
const getBYsubscriber_idStatement = db.prepare(sql.getBYsubscriber_id);
...
const countBYsubscriber_idStatement = db.prepare(sql.countBYsubscriber_id);
