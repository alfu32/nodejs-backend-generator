...
function main(model){
  ...
  memFs['hooks/']=true;
  memFs['hooks/useFetch.options.js']=`export const options = {
  ...
  fs.writeFileSync('generated/hooks/useFetch.options.js',memFs['hooks/useFetch.options.js']);
...
export function use${n}s(host='https://${process.env.PROJECT_DOMAIN}.glitch.me',options={cacheLife: 0,cachePolicy: 'no-cache',}) {
